...
function updateForm(req, res) {
    ...
    try {
        ...
        function retriveData(id) {
            ...
            var basic_query = `select first_name,last_name,Designation,Email,phone_number,Address1,
        Address2,city,state,gender,ZipCode,Relationship_status,Date_Of_Birth from basic_detail where emp_id=${id};`;
        ...
        department from prefences_table where id=${id};`;
            ...
            con.query(basic_query + edu_detail_sch + edu_detail_col + work_details + references +
                preferences + language_known + tech_known, function (err, result) {
                    ...
                    // console.log(tech_lan_obj.PHP[0]);
                    // console.log(result);

                    res.render('job_application_form/updatedform', { result: result, id: id, lan_obj: lan_obj, tech_lan_obj: tech_lan_obj });
